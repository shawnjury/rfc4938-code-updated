...
printPacket(PPPoEPacket *packet, char const *dir)
{
    ...
    switch(packet->code) {
    case CODE_PADI: printf( "PADI "); break;
    case CODE_PADO: printf( "PADO "); break;
    case CODE_PADR: printf( "PADR "); break;
    case CODE_PADS: printf( "PADS "); break;
    case CODE_PADT: printf( "PADT "); break;
    case CODE_PADM: printf( "PADM "); break;
    case CODE_PADN: printf( "PADN "); break;
    case CODE_SESS: printf( "SESS "); break;
    }
    ...
    /* Ugly... I apologize... */
    printf( "SourceAddr %02x:%02x:%02x:%02x:%02x:%02x "
	    "DestAddr %02x:%02x:%02x:%02x:%02x:%02x\n",
	    (unsigned) packet->ethHdr.h_source[0],
	    (unsigned) packet->ethHdr.h_source[1],
	    (unsigned) packet->ethHdr.h_source[2],
